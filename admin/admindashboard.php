    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-3 mt-5 ml-5">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                                ...
                                <i class="fa fa-users fs-1 border rounded-full secondary-bg p-3"></i>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered bg-white table-striped rounded shadow-sm text-center" id="books">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-warning text-dark ps-4 pe-4 shadow-none editcoursebtn">Edit</button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-outline-danger ps-4 pe-4 shadow-none deletecoursebtn">Delete</button>
                                    </td>
                                </tr>
                                <?php
                                    }
                ...
                <!--User Section-->
                <div class="row mx-4 mt-5">
                    <h2 class="mb-2 mt-4 heading" id="users">Users/Students</h2>
                    <p style="color:yellow; text-align: center;font-size:14px;" class="fw-bold">Students informations in this section</p>
                    <div class="col table-responsive-sm">
                        <table class="table table-bordered bg-white table-striped rounded shadow-sm text-center" id="books">
                            <thead>
                                <tr>
                                    <th scope="col" width="50">Register No</th>
                ...
                <!--Faculty Section-->
                <div class="row mx-4 mt-5">
                    <h2 class="mb-2 mt-4 heading" id="users">Faculties</h2>
                    <p style="color:yellow; text-align: center;font-size:14px;" class="fw-bold">Faculties informations in this section</p>
                    <div class="col table-responsive-sm">
                        <table class="table table-bordered bg-white table-striped rounded shadow-sm text-center" id="books">
                            <thead>
                                <tr>
